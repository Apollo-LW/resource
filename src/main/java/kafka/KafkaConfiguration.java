...
public class KafkaConfiguration {
    ...
    @Bean
    KafkaSender<String , Resource> resourceKafkaSender() {
    ...
    @Bean
    KafkaReceiver<String , Resource> resourceKafkaReceiver() {
        ...
        ReceiverOptions<String, Resource> resourceReceiverOptions = ReceiverOptions.create(resourceReceiverProperties);
        return new DefaultKafkaReceiver<String, Resource>(ConsumerFactory.INSTANCE , resourceReceiverOptions.subscription(Collections.singleton(this.topicName)));
    }
}
